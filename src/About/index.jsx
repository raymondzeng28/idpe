  ...
  render() {
    return (
      <div className="body-content">
        ...
        <p className="paragraph">
          I discovered that after drawing any subject, I was able to observe it much more closely in real life. I began to notice details that many others did not. I found my teacher's words very true and observed that students who studied drawing often developed strong attention to detail, a skill which helped them achieve later success.
        </p>
        ...
        <p className="paragraph">
          It was my teachers' great wish for me to continue spreading the importance of drawing to younger generations of artists. In 2021, I decided to move the drawing exhibitions of previous years to an online platform without physical limitations. It is my goal to continue providing a place for young people to exhibit their artwork, take part in meaningful discussions about drawing, and be able to learn from one another.
        </p>
        <p className="paragraph">
          The International Pencil Drawing Exhibition's mission is to continue sharing the importance of drawing and to bring it to new heights.
        </p>
