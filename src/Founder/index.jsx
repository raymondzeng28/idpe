...
class Founder extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      snowInTheRockies: {
        source: `Images/Founder/snow_in_the_rockies.jpg`,
        height: null,
        width: 650,
        title: `Snow in the Rockies`,
        description: `by Uncle Zeng`
      },
      windAndRainBridge: {
  ...
  render() {
    return (
      <div className="body-content">
        ...
        <Artwork picture={ this.state.snowInTheRockies }></Artwork>
        <p className="paragraph">
        ...
        <p className="paragraph">
          Now residing in Canada, Uncle Zeng has continued to give guidance and support to many young artists in China, the United States, and Canada for more than 45 years. He founded the International Pencil Drawing Exhibition to encourage young artists to achieve excellence in drawing.
        </p>
